**I am an Erasmus Mundus Scholar pursuing the Master’s in Big Data Management and Analytics (BDMA) at CentraleSupélec, a program that combines data engineering and data science. My studies and projects cover machine learning and deep learning, database systems, big data processing, semantic data modelling, and both relational and non-relational databases and querying.**

📍 Paris, France | 🔗 LinkedIn: [https://www.linkedin.com/in/marwah-sulaiman](https://www.linkedin.com/in/marwah-sulaiman/)

### Featured Projects

| Project | Description | Tech |
|--------|-------------|------|
| [PostgreSQL Extension for DNA Analysis](https://github.com/marwahmh/PostDNA) | Custom extension for efficient storage, indexing, and analysis of DNA sequences | PostgreSQL, C |
